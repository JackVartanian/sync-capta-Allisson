SELECT
    ...
    RTRIM(d.cpfs) AS "CPF",
    RTRIM(e.dopes) as "Descricao_Operacao",
    MIN(CASE 
...
FROM SLJMFAS t WITH (NOLOCK)
    ...
    LEFT JOIN SLJCLI AS K WITH (NOLOCK) ON e.vends = K.ICLIS
    INNER JOIN (
        SELECT
            CAST(t.nops AS INT) AS "OP",
...
GROUP BY t.nops, t.numps, o.dopps, o.dopes, t.dopps, o.numes, o.dataps, o.dataes, t.datars, e.prazoents, e.contaos, e.dopes, t.qtds, t.grupods, t.contads, t.codpds, b.cftios, b.nivelqs, b.mercs, b.pesoms, tm.MinQtde, tm.Maior_Peso_Fase, e.vends, K.RCLIS, d.rclis, d.cpfs
ORDER BY OP DESC