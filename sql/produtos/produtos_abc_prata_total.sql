    SELECT
        ...
        CONCAT('https://jvphotos.com.br/public_html/wp-content/uploads/colecoes/TODAS/',RTRIM( a.cpros ),'.JPG') AS "Foto",
        a.qtds AS "Qtd",
...
UNION ALL
    ...
    SELECT
        ...
        CONCAT('https://jvphotos.com.br/public_html/wp-content/uploads/colecoes/TODAS/',RTRIM( EESTI.cpros ),'.JPG') AS "Foto",
        EESTI.qtds AS "Qtd",
